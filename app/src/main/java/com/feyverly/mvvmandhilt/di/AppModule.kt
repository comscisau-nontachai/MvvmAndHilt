package com.feyverly.mvvmandhilt.di

import android.content.Context
import com.feyverly.mvvmandhilt.data.local.AppDatabase
...
import com.feyverly.mvvmandhilt.data.remote.CharacterService
...
object AppModule {
    ...
    fun provideRepository(remoteDataSource: CharacterRemoteDataSource,
        ...
        CharacterRepositoty(remoteDataSource, localDataSource)
}